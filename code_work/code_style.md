...
* Описание того, что делает метод (опционально)
...
* Используйте тернарные выражения только в самых простых случаях. Например, для установки дефолтного значения переменной, если нет значения в нужном источнике
* Не используйте тернарные выражения с несколькими уровнями вложенности
* Не рекомендуется использовать тернарные выражения с несколькими условиями.
...
### Служебные слова в SQL-запросах

* Служебные слова в нативных запросах(SELECT, JOIN, WHERE, AS, etc) пишете в верхнем регистре. 
